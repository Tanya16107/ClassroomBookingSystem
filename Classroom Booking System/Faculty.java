...
/**
	*The Faculty class extends User and provides functionalities for a user from the Faculty department. 
*/
public class Faculty extends User{
	...
	*/
	...
	/**
	*A method to know if EmailIDs of Users match
	*@param s the Faculty whose EmailID is to be compared to
